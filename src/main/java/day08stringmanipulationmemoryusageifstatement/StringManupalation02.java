...
public class StringManupalation02 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s==r);//false cunku adresler farki
        System.out.println(s.equals(r));//true cunku equals () sagdece degerlere bakar."s"ve"r" ini degerleri aynı oldugunda


        //Ornek3:Verilen iki string in birbirinin aynisi olup olmadigini buyuk harf kucuk harf dikkate almadan kontrol eden kodu yaziniz

        //equalsIgnoreCase() iki string birbirini aynısı olup olmadıgını buyuk barf kucuk harf dıkkate almadan konturol eder
