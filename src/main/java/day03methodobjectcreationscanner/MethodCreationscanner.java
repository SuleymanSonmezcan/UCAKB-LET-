...
public class MethodCreationscanner {
    ...
    public static void main(String[] args) {
        ...
        int b=5;
        carpmaYap(a,b);
        //ornek4:verilen bir yayinin karesinialip hesaplayıp console a uazdirinmethodu olusturup kullaniniz
    ...
    /*
    homework
    1) cemberin cevresini hesaplayan bir method olusturnuz ve kullanınız.
    2) dairenin  alanını hesaplayan bir method olusturunuz ve kullanınız.
     */
